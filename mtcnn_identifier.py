...
cap = cv2.VideoCapture("/jetson-inference/ferplus-code/input_vid1.mp4")
frame_width = int(cap.get(3))
frame_height = int(cap.get(4))
fourcc = cv2.VideoWriter_fourcc('M','J','P','G')
out = cv2.VideoWriter('/jetson-inference/ferplus-code/output.avi', fourcc, 30.0, (frame_width, frame_height))
...
while True:
    ...
    for result in faces_rect: #For each face
